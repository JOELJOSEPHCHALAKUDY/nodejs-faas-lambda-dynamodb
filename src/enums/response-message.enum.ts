export enum ResponseMessage {
    ...
    DELETE_LEAD_SUCCESS = 'LEAD successfully deleted',
    DELETE_LEAD_FAIL = 'Lead cannot be deleted',
    ...
    DELETE_INTEREST_SUCCESS = 'Interest successfully deleted',
    DELETE_INTEREST_FAIL = 'Interest could not be deleted',
